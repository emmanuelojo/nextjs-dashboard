                ...
                <div className="w-full">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                {passwordVisible ? (
                                    <EyeIcon className="h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
                                ) : (
                                    <EyeSlashIcon className="h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
                                )}
                            </div>
                        </div>
                    </div>
